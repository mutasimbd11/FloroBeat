...
import com.florosoft.florobeat.playback.EqualizerProcessor
import com.florosoft.florobeat.playback.manualCurve
import com.florosoft.florobeat.playback.toneCurve
...
class EqualizerProcessorTest {
    ...
    /**
     * The two end bands are shelves, not bells — see [com.florosoft.florobeat.playback.FilterKind].
