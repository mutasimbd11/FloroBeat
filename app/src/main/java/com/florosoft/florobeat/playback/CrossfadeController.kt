...
import com.florosoft.florobeat.data.settings.SmartAnalysis
import com.florosoft.florobeat.data.settings.TrackAnalysisState
import com.florosoft.florobeat.data.settings.TransitionWindow
import com.florosoft.florobeat.playback.smart.CrossfadeMode
import com.florosoft.florobeat.playback.smart.TrackAnalysis
import com.florosoft.florobeat.playback.smart.TransitionStyle
import com.florosoft.florobeat.playback.smart.TransitionTrackInfo
import com.florosoft.florobeat.playback.smart.planTransition
...
class CrossfadeController(
     ...
     * makes a plan's
     * [com.florosoft.florobeat.playback.smart.TransitionPlan.transitionStyle] audible
    ...
    /**
     * The style fields of a [com.florosoft.florobeat.playback.smart.TransitionPlan],
     ...
     * ([com.florosoft.florobeat.playback.smart.TransitionPlan.incomingCueTime]),
     * and the tempo-stretch to align it with the outgoing track
     * ([com.florosoft.florobeat.playback.smart.TransitionPlan.incomingPlaybackRate])
     * — see [driveLap], which applies both at the handoff — and the style the
     * blend is rendered in
     * ([com.florosoft.florobeat.playback.smart.TransitionPlan.transitionStyle]),
     ...
     * [com.florosoft.florobeat.playback.smart.TrackAnalyzer.request] as the next
    ...
    /** FloroBeat doesn't carry album metadata on [MediaMetadata] yet, so [TransitionTrackInfo.album] stays blank. */
    ...
    private companion object {
        const val TAG = "FloroBeatCrossfade"
