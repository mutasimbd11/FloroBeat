 ...
 *
 * The queue holds `florobeat://watch?v=…` URIs that
...
object QualityUpgrade {
     ...
     * [PlaybackService][com.florosoft.florobeat.playback.PlaybackService].
     */
     ...
     *   [PlaybackService.audioFormatFor][com.florosoft.florobeat.playback.PlaybackService].
     ...
     * [PlaybackService.upgradeQualityNow][com.florosoft.florobeat.playback.PlaybackService].
     *
