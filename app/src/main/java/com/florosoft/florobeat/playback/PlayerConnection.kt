 ...
 */
private const val EXTRA_FROM_AUTOPLAY = "florobeat.fromAutoplay"

/** @see Song.radioName */
private const val EXTRA_RADIO_NAME = "florobeat.radioName"

/** @see Song.playbackSource */
private const val EXTRA_PLAYBACK_SOURCE = "florobeat.playbackSource"
private const val EXTRA_PLAYBACK_SOURCE_TYPE = "florobeat.playbackSourceType"
private const val EXTRA_PLAYBACK_SOURCE_ID = "florobeat.playbackSourceId"
 ...
 */
private const val EXTRA_ARTIST_ID = "florobeat.artistId"
private const val EXTRA_ALBUM_ID = "florobeat.albumId"

/** @see Song.setVideoId */
private const val EXTRA_SET_VIDEO_ID = "florobeat.setVideoId"

/** @see Song.localUri */
private const val EXTRA_LOCAL_URI = "florobeat.localUri"

/** @see Song.localPath */
private const val EXTRA_LOCAL_PATH = "florobeat.localPath"
 ...
 */
private const val EXTRA_DURATION = "florobeat.durationText"
private const val EXTRA_EXPLICIT = "florobeat.explicit"
private const val EXTRA_IS_VIDEO = "florobeat.isVideo"
private const val EXTRA_VIDEO_ORIGIN = "florobeat.isVideoOrigin"

/** Set only on the replacement item produced by [QualityUpgrade]. */
const val EXTRA_QUALITY_UPGRADED = "florobeat.qualityUpgraded"
 ...
 * terms [com.florosoft.florobeat.data.sources.TrackMatcher] compares recordings on.
 *
...
fun Song.toMediaItem(): MediaItem {
    ...
    val uriString = offlineUri ?: when {
        ...
        // reach.
        else -> "florobeat://watch?v=$videoId${matchQuery()}"
    }
...
private fun Song.directYouTubeUri(): String =
    "florobeat://watch?v=$videoId${matchQuery()}&$DIRECT_YOUTUBE_PARAMETER=1&q=original"
 ...
 * — see [com.florosoft.florobeat.data.TrackLog.about].
 *
