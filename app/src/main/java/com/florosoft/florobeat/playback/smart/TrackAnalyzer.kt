...
package com.florosoft.florobeat.playback.smart
...
class TrackAnalyzer(private val context: Context, private val cache: AudioCache) {
    ...
    private val executor = Executors.newSingleThreadExecutor { runnable ->
        Thread(runnable, "florobeat-smart-analysis").apply {
            isDaemon = true
    ...
    private suspend fun findYouTubeMatch(target: TrackMatcher.Target): com.florosoft.florobeat.data.model.Song? {
    ...
    private companion object {
        const val TAG = "FloroBeatTrackAnalyzer"
