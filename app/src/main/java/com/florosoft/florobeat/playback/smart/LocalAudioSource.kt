 ...
 * [com.florosoft.florobeat.playback.AudioCache], because that is where *streamed*
 * audio lands. A track playing off the device never goes there:
 * [com.florosoft.florobeat.playback.AudioCache.playbackFactory] routes `file://` and
 ...
 * [com.florosoft.florobeat.playback.AudioCache.requestAnalysisHead] — the fallback
...
internal object LocalAudioSource {
    ...
    private const val TAG = "FloroBeatLocalAudio"
