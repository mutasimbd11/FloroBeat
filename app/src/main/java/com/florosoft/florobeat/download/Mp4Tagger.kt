...
import com.florosoft.florobeat.data.lyrics.WORD_LYRICS_FIELD
...
object Mp4Tagger {
     ...
     * file — see [EmbeddedLyrics][com.florosoft.florobeat.data.lyrics.EmbeddedLyrics],
    ...
    private const val MEAN = "com.florosoft.florobeat"
