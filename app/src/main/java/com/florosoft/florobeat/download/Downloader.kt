 ...
 *    the same finding [ChunkedDataSource][com.florosoft.florobeat.playback.ChunkedDataSource]
 *    exists for.
...
object Downloader {
     ...
     *    URL — see [SourceStream.headers][com.florosoft.florobeat.data.sources.SourceStream.headers]
