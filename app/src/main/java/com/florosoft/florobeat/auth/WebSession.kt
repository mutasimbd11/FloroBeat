package com.florosoft.florobeat.auth
 ...
 * signing out of FloroBeat forgets the cookie the app makes requests with, and
...
object BrowserSession {
    ...
    fun clearGoogleCookies() {
        ...
        val manager = runCatching { CookieManager.getInstance() }.getOrElse {
            Log.w("FloroBeat", "no cookie manager to clear: ${it.message}")
            return
        }
        var cleared = 0
        ...
        Log.d("FloroBeat", "cleared $cleared browser cookies for Google")
    }
