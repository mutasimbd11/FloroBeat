...
/**
 * FloroBeat's tactile scrubber: an expressive hairline capsule
 * that thickens smoothly under touch and carries the luminous FloroMint identity.
 */
@Composable
fun ThinSlider(
    value: Float,
     ...
     * [com.florosoft.florobeat.data.settings.AppSettings.smartMixInProgress].
     */
    ...
    markerColor: Color = FloroMintLight.copy(alpha = 0.55f),
) {
