 ...
 * [StreamResolver][com.florosoft.florobeat.data.innertube.StreamResolver]. Sources
...
data class SourceStream(
     ...
     * [QualityUpgrade][com.florosoft.florobeat.playback.QualityUpgrade].
     */
     ...
     * see [QualityUpgrade][com.florosoft.florobeat.playback.QualityUpgrade.lookAgain].
     ...
     * [QualityUpgrade][com.florosoft.florobeat.playback.QualityUpgrade]) can leave
 ...
 * [AppSettings][com.florosoft.florobeat.data.settings.AppSettings] and is turned
