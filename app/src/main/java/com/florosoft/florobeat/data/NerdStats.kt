...
object NerdStats {
     ...
     * [QualityUpgrade.adoptUnresolved][com.florosoft.florobeat.playback.QualityUpgrade.adoptUnresolved].
    ...
    fun sourceFor(mediaId: String?): String? {
        ...
        return sources[key]
            ?: com.florosoft.florobeat.data.sources.SourceRegistry.parseTrackKey(key)
     ...
     * [PlaybackService][com.florosoft.florobeat.playback.PlaybackService] — which the
     ...
     *
     * @see com.florosoft.florobeat.playback.QualityUpgrade.forgetLastSession for the
