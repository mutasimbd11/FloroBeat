...
import com.florosoft.florobeat.data.sources.addon.AddonClient
import com.florosoft.florobeat.data.sources.addon.AddonException
import com.florosoft.florobeat.data.sources.addon.DetectedFormat
import com.florosoft.florobeat.data.sources.addon.SourceFormats
...
object SourceRegistry {
    ...
    fun init(context: Context) {
        prefs = runCatching {
            ...
            context.getSharedPreferences("florobeat_sources_plain", Context.MODE_PRIVATE)
        }
     ...
     * file is worth is [DownloadQuality][com.florosoft.florobeat.data.settings.DownloadQuality]'s
     * question, and when it may be fetched is
     * [AppSettings.wifiOnlyDownloads][com.florosoft.florobeat.data.settings.AppSettings.wifiOnlyDownloads]'s.
     */
     ...
     * see [SourcesScreen][com.florosoft.florobeat.ui.screens.SourcesScreen].
     */
     ...
     *
     * Packed into the existing [Song.videoId][com.florosoft.florobeat.data.model.Song.videoId]
