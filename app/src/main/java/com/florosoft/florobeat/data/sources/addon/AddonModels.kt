 ...
 * [module][com.florosoft.florobeat.data.sources.module] rather than inside it —
...
data class AddonManifest(
     ...
     * parameters on every request; FloroBeat has no such form, so it sends the
     ...
     * [AddonSource][com.florosoft.florobeat.data.sources.AddonSource] falls back to
 ...
 * [MusicSource][com.florosoft.florobeat.data.sources.MusicSource] is asked for
 ...
 * [StreamContainer][com.florosoft.florobeat.playback.StreamContainer] is told
...
data class AddonStream(
     ...
     * failure [StreamContainer][com.florosoft.florobeat.playback.StreamContainer]
     * exists to describe.
     *
