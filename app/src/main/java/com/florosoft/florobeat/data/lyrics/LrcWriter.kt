package com.florosoft.florobeat.data.lyrics
 ...
 * `com.florosoft.florobeat.download.LyricsTag`), and LRC is what that field is read
 ...
 * atom, where every other player looks, and this to a FloroBeat-specific one
