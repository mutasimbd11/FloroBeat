package com.florosoft.florobeat.data.model
...
data class Song(
    ...
    /** A premium rendition marker recorded by FloroBeat for its Downloads list. */
     ...
     * that need it — see [com.florosoft.florobeat.playback.toMediaItem].
     */
...
data class LibraryPage(
     ...
     * [com.florosoft.florobeat.data.LikeState]; never stored as page state.
     */
...
data class DetailPage(
     ...
     * added — see [com.florosoft.florobeat.data.innertube.InnertubeParser.parsePlaylistShelf].
