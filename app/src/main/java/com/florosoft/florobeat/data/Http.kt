 ...
 * `next`-endpoint fetches, [ChunkedDataSource][com.florosoft.florobeat.playback.ChunkedDataSource]
 * and [AudioCache][com.florosoft.florobeat.playback.AudioCache]'s multi-megabyte
