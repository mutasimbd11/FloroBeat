package com.florosoft.florobeat.data.sources.module
 ...
 * [SourceRegistry][com.florosoft.florobeat.data.sources.SourceRegistry] never
 ...
 *
 * Ported from Convx's `ModuleManager`, adapted to use FloroBeat's shared
...
class ModuleManager {
     ...
     *
     * Concurrent because [ModuleSource.search][com.florosoft.florobeat.data.sources.ModuleSource.search]
    ...
    private companion object {
         ...
         * [TrackMatcher][com.florosoft.florobeat.data.sources.TrackMatcher] one —
         ...
         * trade [StreamChoice][com.florosoft.florobeat.playback.StreamChoice] makes,
