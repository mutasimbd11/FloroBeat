package com.florosoft.florobeat.data.sources
...
object SourceResolver {
    ...
    private const val TAG = "FloroBeat"
    ...
    /**
     * @param uri a `florobeat://source?...` URI as built by [SourceRegistry.trackUri].
     ...
     * [toMediaItem][com.florosoft.florobeat.playback.toMediaItem].
     */
     ...
     * playback as `florobeat://watch?v=…` and never passes through [resolve].
     ...
     * [StreamChoice][com.florosoft.florobeat.playback.StreamChoice] before caching a
     ...
     * plays lossy for the rest of its length, because [QualityUpgrade][com.florosoft.florobeat.playback.QualityUpgrade]
     ...
     * directly — see
     * [resolveForDownload][com.florosoft.florobeat.data.innertube.StreamResolver.resolveForDownload]
     ...
     *
     * [DownloadQuality.LOSSLESS][com.florosoft.florobeat.data.settings.DownloadQuality.LOSSLESS]
     * and [DownloadQuality.HIGH][com.florosoft.florobeat.data.settings.DownloadQuality.HIGH];
     * not [DownloadQuality.STANDARD][com.florosoft.florobeat.data.settings.DownloadQuality.STANDARD].
     ...
     * the live lookup [QualityUpgrade][com.florosoft.florobeat.playback.QualityUpgrade]
     ...
     * [AudioCache][com.florosoft.florobeat.playback.AudioCache] decide how to treat
     ...
     * [PlaybackService][com.florosoft.florobeat.playback.PlaybackService]'s
