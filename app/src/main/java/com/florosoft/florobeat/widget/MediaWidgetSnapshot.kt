 ...
 * connecting one means starting [PlaybackService][com.florosoft.florobeat.playback.PlaybackService]
 * just to find out what to draw. So the service writes here whenever the answer
 * changes ([publishWidgetState][com.florosoft.florobeat.playback.PlaybackService]) and
...
internal data class MediaWidgetSnapshot(
    ...
    companion object {
        ...
        private fun prefs(context: Context) =
            context.getSharedPreferences("florobeat_widget", Context.MODE_PRIVATE)
