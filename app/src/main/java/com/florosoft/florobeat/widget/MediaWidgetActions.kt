package com.florosoft.florobeat.widget
...
import com.florosoft.florobeat.playback.PlaybackService
 ...
 * from [rememberMediaController][com.florosoft.florobeat.playback.rememberMediaController].
 *
...
class MediaWidgetActions : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val ACTION_TOGGLE = "com.florosoft.florobeat.widget.TOGGLE"
        const val ACTION_NEXT = "com.florosoft.florobeat.widget.NEXT"
        const val ACTION_PREVIOUS = "com.florosoft.florobeat.widget.PREVIOUS"
